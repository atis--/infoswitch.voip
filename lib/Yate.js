...
module.exports = (function () {
    ...
    YateExt.prototype._install_message_handlers = function () {
        ...
        this.on('user.auth', function (user_auth) {
            ...
            // allow if this is a call, and if we allow calls from unregistered
            if (user_auth.newcall == 'true' && this.allowUnregistered)
                return allow();
            ...
            // XXX we may still want to pass this through the authenticator
            // XXX function
            ...
            var digest = extend_defined({}, {
                newcall: user_auth.newcall == 'true',   // call authorization
                username: username,
